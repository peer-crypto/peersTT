...
)
{
    ...
    Column(
        ...
        HeJumpGasPicker(
            title = "From Gas",
            o2Pct = vm.fromO2Pct.toIntOrNull() ?: 0,
            hePct = vm.fromHePct.toIntOrNull() ?: 0,
            onO2Change = { vm.updateFrom(o2Pct = it.toString()) },
            onHeChange = { vm.updateFrom(hePct = it.toString()) }
        )
        ...
        HeJumpGasPicker(
            title = "To Gas",
            o2Pct = vm.toO2Pct.toIntOrNull() ?: 0,
            hePct = vm.toHePct.toIntOrNull() ?: 0,
            onO2Change = { vm.updateTo(o2Pct = it.toString()) },
            onHeChange = { vm.updateTo(hePct = it.toString()) }
        )
        ...
        Box(
            ...
            vm.result?.let { r ->
                ...
                when {
                    hasLeanToHeavy -> {
                        statusText = "❌ Never switch from a helium-lean gas to a helium-rich gas during ascent!"
